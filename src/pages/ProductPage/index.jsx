...
const ProductPage = () => {
  ...
  // Sample image gallery (in a real app, this would come from product data)
  const imageGallery = [
    product.imageUrl,
  ...
  const toggleWishlist = () => {
    ...
    // Here you would typically update your global state or make an API call
  };
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-center mb-6">
                ...
                <button className="flex-1 bg-[#05B171] text-white px-6 py-3 rounded-md hover:bg-[#048a5b] transition-colors flex items-center justify-center gap-2">
