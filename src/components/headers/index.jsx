...
import { Badge, IconButton, Tooltip, Drawer, Box } from '@mui/material';
import { styled } from '@mui/material/styles';
import {  IoCartOutline, IoMenu, IoClose, IoHomeOutline, IoSearchOutline} from "react-icons/io5";
           ...
           <div className="top-strip py-2 border-t-[1px] border-gray-250 border-b-[1px] hidden md:block bg-gray-50">
            ...
            <div className="header border-b border-opacity-20 border-gray-300 bg-white">
                <div className="container">
                    ...
                    {/* Desktop Header - Keep original layout */}
